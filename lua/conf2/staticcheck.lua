-- copied from null_ls lua/null-ls/builtins/diagnostics/staticcheck.lua
-- modified errors showing as warnings
...
local severities = {
  ...
  error = vim.lsp.protocol.DiagnosticSeverity.Warning,
